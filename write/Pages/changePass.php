...
<body>
    <div class="h1_title-pass">
        <h1>Change Password</h1>
    </div>
    <form action="../php/changePass.php" method="POST">
    <div class="change_div">
        <input type="password" name="pw" class="input-pass" placeholder="Password">
        <input type="password" name="pw2" class="input-pass2" placeholder="Confirm Password">
        <button type="submit" name="submit" class="changePass_btn">Change</button>
    </div>
    </form>
